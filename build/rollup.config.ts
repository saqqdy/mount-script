...
const configs: Config[] = [
	{
		input: 'src/index.ts',
		file: 'dist/mount-script.esm-browser.js',
		format: 'es',
		browser: true,
		env: 'development'
	},
	{
		input: 'src/index.ts',
		file: 'dist/mount-script.esm-browser.prod.js',
		format: 'es',
		browser: true,
		minify: true,
		env: 'production'
	...
	{
		input: 'src/index.ts',
		file: 'dist/mount-script.esm-bundler.js',
		format: 'es',
		env: 'development'
	},
	{
		input: 'src/index.ts',
		file: 'dist/mount-script.mjs',
		format: 'es',
		env: 'development'
	},
	{
		input: 'src/index.ts',
		file: 'dist/mount-script.global.js',
		format: 'iife',
		env: 'development'
	},
	{
		input: 'src/index.ts',
		file: 'dist/mount-script.global.prod.js',
		format: 'iife',
		minify: true,
		env: 'production'
	},
...
function createEntry(config: Config) {
	...
	if (isGlobalBuild) {
		_config.output.name = _config.output.name || 'mountScript'
	}
